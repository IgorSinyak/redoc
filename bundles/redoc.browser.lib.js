          ...
          function D(e, t, r, n, i) {
            for (let s in e) {
              ...
              for (let e in a)
                if (y.httpMethods.indexOf(e) >= 0 || 'x-amazon-apigateway-any-method' === e) {
                  ...
                  if (p && p.parameters && Array.isArray(p.parameters)) {
                    ...
                    r.rbname && '' === p[r.rbname] && delete p[r.rbname],
                      r.debug || (p.parameters && (p.parameters = p.parameters.filter(A)));
                  }
              ...
              if (a && a.parameters) {
                ...
                !r.debug && Array.isArray(a.parameters) && (a.parameters = a.parameters.filter(A));
              }
            }
          }
          function _(e) {
        ...
        class Y {
          ...
          constructor(e, t = {}) {
            ...
            (null == (r = e.theme) ? void 0 : r.menu) &&
              ...
              })(S({}, i, ((c = W({}, e.theme)), N(c, q({ extensionsHook: void 0 })))))),
...
`;
        ...
        class Re {
          ...
          static relative(e, t) {
            const r = Re.parse(e);
            return Re.parse(t).slice(r.length);
          }
          static parse(e) {
            let t = e;
        ...
        (Ee.parse = Re.parse), Object.assign(Re, Ee);
        var Se = r(470),
          ...
          De = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          _e = (e, t) => {
            for (var r in t || (t = {})) Ie.call(t, r) && De(e, r, t[r]);
            if (Pe) for (var r of Pe(t)) Te.call(t, r) && De(e, r, t[r]);
            return e;
          },
          Le = (e, t) => $e(e, Ce(t));
        function Fe(e) {
        ...
        function Me(e) {
          return 'default' === e || k(e) || Fe(e);
        }
        function Ne(e, t = !1) {
          if ('default' === e) return t ? 'error' : 'success';
          let r = 'string' == typeof e ? parseInt(e, 10) : e;
          if ((Fe(e) && (r *= 100), r < 100 || r > 599)) throw new Error('invalid HTTP code');
          let n = 'success';
          return (
            r >= 300 && r < 400
              ? (n = 'redirect')
            ...
            void 0 === e
              ? T(
                  (() => {
                    ...
                    return e.endsWith('.html') ? (0, Se.dirname)(e) : e;
                  })(),
                )
              : (0, Se.dirname)(e);
          return (
        ...
        function Et(e) {
          ...
          if (r) {
            ...
            for (const e of Object.keys(r)) {
              const n = r[e];
              t[e] = Le(_e({}, t[e]), { examples: n });
            }
          } else if (n) {
            t = _e({}, t);
            for (const e of Object.keys(n)) {
              const r = n[e];
              t[e] = Le(_e({}, t[e]), { example: r });
            }
          }
          return t;
        }
        ...
        function St(e, t = 'clike') {
          t = t.toLowerCase();
          let r = kt.languages[t];
          return r || (r = kt.languages[Rt(t)]), kt.highlight(e.toString(), r, t);
        }
        function jt(e) {
          return (t, r, n) => {
        ...
        var Ct = Object.defineProperty,
          ...
          Lt = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Ft = (e, t) => {
            for (var r in t || (t = {})) Dt.call(t, r) && Lt(e, r, t[r]);
            if (Tt) for (var r of Tt(t)) _t.call(t, r) && Lt(e, r, t[r]);
            return e;
          },
          Mt = (e, t) => Pt(e, It(t));
        const Nt = {};
        ...
        Yt.marked.setOptions({ renderer: or, highlight: (e, t) => St(e, t) });
        ...
        class cr {
          ...
          saveHeading(e, t, r = this.headings, n) {
            e = _(e);
            const o = { id: n ? `${n}/${A(e)}` : `section/${A(e)}`, name: e, level: t, items: [] };
            return r.push(o), o;
          }
          flattenHeadings(e) {
            if (void 0 === e) return [];
        ...
        var vr = Object.defineProperty,
          ...
          jr = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Ar = (e, t) => {
            for (var r in t || (t = {})) Rr.call(t, r) && jr(e, r, t[r]);
            if (kr) for (var r of kr(t)) Sr.call(t, r) && jr(e, r, t[r]);
            return e;
          },
          $r = (e, t, r, n) => {
        ...
        $r([fe.observable], Cr.prototype, 'expanded', 2),
          $r([fe.action], Cr.prototype, 'toggle', 1);
        var Pr = Object.defineProperty,
          ...
          Nr = (e, t) => {
            ...
            if (_r) for (var r of _r(t)) Fr.call(t, r) && Mr(e, r, t[r]);
            return e;
          },
          qr = (e, t) => Ir(e, Dr(t)),
          zr = (e, t, r, n) => {
        ...
        const Br = class {
          ...
          init(e, t) {
            ...
            if (
              ...
              (this.title = r.title || (nt(this.pointer) && Re.baseName(this.pointer)) || ''),
              ...
              if (t || void 0 === Ur(r)) {
                ...
                if (this.hasType('object'))
                  ...
                  (this.typePrefix = this.items.typePrefix + F('arrayOf')),
              ...
              ((this.oneOf = e.map((e, r) => {
                const n = t.deref(e, !1, !0),
                  ...
                  s = new Br(
                    ...
                    qr(Nr({}, o), {
                      title: i,
                      allOf: [qr(Nr({}, this.schema), { oneOf: void 0, anyOf: void 0 })],
                    }),
        ...
        var On = Object.defineProperty,
          ...
          An = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          $n = (e, t) => {
            for (var r in t || (t = {})) Sn.call(t, r) && An(e, r, t[r]);
            if (Rn) for (var r of Rn(t)) jn.call(t, r) && An(e, r, t[r]);
            return e;
          };
        class Cn {
          constructor(e, t, r) {
          ...
          initWebhooks(e, t, r) {
            for (const o of Object.keys(t)) {
              ...
              for (const t of s) {
                ...
                if (!o) continue;
                const s = new wn(e, ((n = $n({}, o)), En(n, kn({ httpVerb: t }))), void 0, r, !1);
        ...
        var Tn = Object.defineProperty,
          ...
          Nn = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          qn = (e, t) => {
            for (var r in t || (t = {})) Fn.call(t, r) && Nn(e, r, t[r]);
            if (Ln) for (var r of Ln(t)) Mn.call(t, r) && Nn(e, r, t[r]);
            return e;
          };
        class zn {
          constructor() {
          ...
          mergeRefs(e, t, r) {
            const n = e,
              ...
              i = ((e, t) => {
                ...
                if (null != e && Ln)
                  for (var n of Ln(e)) t.indexOf(n) < 0 && Mn.call(e, n) && (r[n] = e[n]);
                return r;
              })(n, ['$ref']),
              s = Object.keys(i);
            return 0 === s.length
...
`),
  ...
  ${oe('UnderlinedHeader')};
`,
          Do = (0, e.createContext)(void 0),
          { Provider: _o, Consumer: Lo } = Do;
        function Fo(t) {
...
`;
  ...
  > ul {
    ...
    > li {
      ...
      margin: 0
        ${({ theme: e }) => `${e.spacing.unit}px 16px ${e.spacing.unit}px`};
      background: #fff;
        ...
        function Li(t) {
          ...
          return 1 === t.options.length
            ...
            : e.createElement(
                n,
                ((o = ((e, t) => {
                  for (var r in t || (t = {})) Ti.call(t, r) && _i(e, r, t[r]);
                  if (Ii) for (var r of Ii(t)) Di.call(t, r) && _i(e, r, t[r]);
                  return e;
                })({}, t)),
        ...
        var qi = Object.defineProperty,
          ...
          Ui = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        const Wi = Ni.withComponent('span');
        function Vi(t) {
          const r = t.inline ? Wi : Ni;
              ...
              ((e, t) => {
              ...
              })(
                {
                  ...
                  dangerouslySetInnerHTML: {
                    __html: ((o = n.untrustedSpec), (i = t.html), o ? Fi.sanitize(i) : i),
                  },
...
`;
        class hs extends e.PureComponent {
          render() {
            ...
            return e.createElement(fi, { dangerouslySetInnerHTML: { __html: St(t, r) } });
          }
        }
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                r ? F('enumArray') : '',
                ' ',
                1 === t.length ? F('enumSingleValue') : F('enum'),
                ':',
              ),
              ' ',
              s.map((t, r) => {
                const n = o ? String(t) : JSON.stringify(t);
                return e.createElement(e.Fragment, { key: r }, e.createElement(Ls, null, n), ' ');
              }),
              a
                ? e.createElement(
                    Qs,
        ...
        function Vs({ field: t }) {
          return t.examples
            ? e.createElement(
                e.Fragment,
                null,
                e.createElement(As, null, ' ', F('examples'), ': '),
                e.createElement(
                  Hs,
                  null,
                  Object.values(t.examples).map((r, n) =>
                    e.createElement(
                      'li',
                      { key: n },
                      e.createElement(Ls, null, et(t, r.value)),
                      ' -',
                      ' ',
        ...
        const ia = e.memo(function (t) {
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              a.isCircular && e.createElement(Ds, null, ' ', F('recursive'), ' '),
            ...
            c &&
              e.createElement(
                'div',
                null,
                e.createElement(Wo, { type: 'warning' }, ' ', F('deprecated'), ' '),
              ),
            e.createElement(Ys, { raw: h, label: F('default') + ':', value: a.default }),
            ...
            (s && s(t)) || null,
            (d && e.createElement(Ys, { label: F('const') + ':', value: d })) || null,
          );
        });
...
`;
              ...
              d = p
                ? e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(Uo, { direction: u ? 'down' : 'right' }),
                    ),
                    l && e.createElement(Ts, null, ' REQUIRED '),
                  )
                : e.createElement(
                    Go,
        ...
        var Ea = Object.defineProperty,
          ...
          Ca = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Pa = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Ra(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
              ...
              : e.createElement(
                  ...
                  e.createElement(
                    ...
                    t[r.activeOneOf].deprecated &&
                      e.createElement(Wo, { type: 'warning' }, 'Deprecated'),
                  ),
                  e.createElement(
                    Qa,
                    ((n = ((e, t) => {
                      for (var r in t || (t = {})) Aa.call(t, r) && Ca(e, r, t[r]);
                      if (ja) for (var r of ja(t)) $a.call(t, r) && Ca(e, r, t[r]);
                      return e;
                    })({}, this.props)),
        ...
        Ta = Pa([Ss.observer], Ta);
        var Da = Object.defineProperty,
          _a = Object.defineProperties,
          La = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          ...
          za = (e, t) => {
            ...
            if (Fa) for (var r of Fa(t)) Na.call(t, r) && qa(e, r, t[r]);
            return e;
          },
          Ba = (e, t) => _a(e, La(t));
          ...
          render() {
            ...
            const r = this.props,
              ...
              o = ((e, t) => {
                ...
                if (null != e && Fa)
                  for (var n of Fa(e)) t.indexOf(n) < 0 && Na.call(e, n) && (r[n] = e[n]);
                return r;
              })(r, ['schema']),
              i = (o.level || 0) + 1;
            ...
            if (c)
              return e.createElement(
                ...
                e.createElement(Ds, null, ' ', F('recursive'), ' '),
              );
            if (void 0 !== l)
              return a && a.length
                ? e.createElement(
        ...
        class Ya extends e.PureComponent {
          ...
          get mediaModel() {
            ...
            return (
              this._mediaModel ||
                (this._mediaModel = new Kr(e, 'json', !1, Ya.getMediaType(t, r), n)),
              this._mediaModel
            );
          }
          render() {
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      Po,
                      null,
                      e.createElement(zo, { to: t.sectionId }),
                      t.displayName,
                    ),
        ...
        class vl extends e.Component {
          render() {
            return e.createElement(he, null, t =>
              e.createElement(Lo, null, e => this.renderWithOptionsAndStore(t, e)),
            );
          }
...
`,
  ...
  cursor: pointer;
  color: ${e => (e.active ? kl(e.depth, e, 'activeTextColor') : e.theme.sidebar.textColor)};
  margin: 0;
  ...
  &:hover {
    color: ${e => kl(e.depth, e, 'activeTextColor')};
  }
        ...
        class Pl extends e.PureComponent {
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(Dl, { type: i }, xt(i)),
              e.createElement(Uo, {
                size: '1.5em',
              ...
              s ? e.createElement(Wo, { type: 'warning' }, ' ', F('deprecated'), ' ') : null,
            );
          }
        }
        const Il = ne.button`
...
`,
  ...
  margin-top: 5px;
`;
        class Fl extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.selectElement = () => {
        ...
        let Hl = class extends e.Component {
          ...
          render() {
            ...
            const r = t.activeMimeIdx,
              ...
              o = ({ children: t }) => (this.props.withLabel ? e.createElement(ws, null, t) : t);
            return e.createElement(
              e.Fragment,
              null,
              e.createElement(
...
`,
  ...
  position: relative;
`;
        class cc extends e.PureComponent {
          render() {
        ...
        var pc = Object.defineProperty,
          ...
          hc = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        class fc extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t =>
                e.createElement(
                  ...
                  e.createElement(
                    Li,
                    ((e, t) => {
                      for (var r in t || (t = {})) dc.call(t, r) && hc(e, r, t[r]);
                      if (uc) for (var r of uc(t)) mc.call(t, r) && hc(e, r, t[r]);
                      return e;
                    })({}, t),
                  ),
                ));
        ...
        const yc = (0, Ss.observer)(({ response: t }) => {
            const {
                extensions: r,
                headers: n,
                type: o,
            ...
            return e.createElement(
              ...
              l && !u && e.createElement(ic, null, e.createElement(fc, { response: t })),
            );
          }),
          gc = ne.h3`
  font-size: 1.3em;
          ...
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  lc,
                  null,
                  e.createElement(gc, null, F(r ? 'callbackResponses' : 'responses')),
...
`;
        ...
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let $c = class extends e.Component {
          render() {
        ...
        let Pc = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              r && e.createElement($c, { operation: this.props.callbackOperation }),
            );
          }
        };
        Pc = ((e, t, r, n) => {
            ...
            super(...arguments),
              (this.renderDropdown = t =>
                e.createElement(
                  Li,
                  ((e, t) => {
                    for (var r in t || (t = {})) Fc.call(t, r) && Nc(e, r, t[r]);
                    if (Lc) for (var r of Lc(t)) Mc.call(t, r) && Nc(e, r, t[r]);
                    return e;
            ...
            return (
              (n &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(Io, null, ' ', F('requestSamples'), ' '),
                  e.createElement(
                    ui,
                    { defaultIndex: 0 },
                    e.createElement(
            ...
            return (
              (r.length > 0 &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(Io, null, ' ', F('responseSamples'), ' '),
                  e.createElement(
                    ui,
                    { defaultIndex: 0 },
                    e.createElement(
...
`;
        ...
        gp = fp([Ss.observer], gp);
        const bp = t => e.createElement(Oo, { compact: !0 }, t);
        let xp = class extends e.Component {
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(vl, { source: r || '', htmlWrap: bp }),
              n &&
                e.createElement(
                  So,
                  null,
                  e.createElement(Oo, null, e.createElement(zs, { externalDocs: n })),
                ),
            );
          }
        };
        xp = fp([Ss.observer], xp);
        let vp = class extends e.Component {
          render() {
            return e.createElement(sp, { operation: this.props.item });
          }
        };
        vp = fp([Ss.observer], vp);
            ...
            return e.createElement(
              ...
              'operation' === t.type
                ? e.createElement(
                    Pp,
                    ((n = ((e, t) => {
                      for (var r in t || (t = {})) Sp.call(t, r) && Ap(e, r, t[r]);
                      if (Rp) for (var r of Rp(t)) jp.call(t, r) && Ap(e, r, t[r]);
                      return e;
                    })({}, this.props)),
                    Op(n, kp({ item: t }))),
                  )
        ...
        let Pp = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              t.isWebhook
                ? e.createElement(El, { type: 'hook' }, F('webhook'))
        ...
        let Mp = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(Fp, { items: t.items, onActivate: this.activate, root: !0 }),
              e.createElement(
                Cl,
                null,
                e.createElement(
...
`,
  ...
  position: relative;
`,
          Xp = ne.input.attrs(() => ({ className: 'search-input' }))`
...
`;
            ...
            return (
              ...
              e.createElement(
                ...
                this.state.term && this.state.noResults
                  ? e.createElement(Kp, { 'data-role': 'search:results' }, F('noResultsFound'))
                  : null,
              )
            );
          }
        ...
        ((e, t, r, n) => {
          for (var o, i = ru(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && tu(t, r, i);
        })([we.bind, (0, we.debounce)(400)], nu.prototype, 'searchCallback');
        ...
        ou.propTypes = { store: ue.instanceOf(rl).isRequired };
        const iu = function (t) {
